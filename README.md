...
- **10–15 factors**, written to full schema depth
- **5–6 tumor types**, prioritising those with high Indian incidence (oral/head and neck, gallbladder, cervical, breast)
...
## Two findings from the scoping phase
...
**Pilot result (8 factors × 5 tumor types, 40 cells):** 62% of cells have no data; 10% have Indian data; cervical cancer is uncharacterised for every factor despite high Indian incidence.
